...
const dispatch =  useDispatch()
  ...
  const getKeeperDetails =  async ()=>{
    const res1 = await fetch("https://emommerce-project2-1.onrender.com/api/keeperDetails")
    const response1 = await res1.json()
    const res2 = await fetch("https://emommerce-project2-1.onrender.com/api/categoryimage")
