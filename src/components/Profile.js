...
const res = await fetch("https://emommerce-project2-1.onrender.com/user/userlogout",{
  method: "GET",
...
const handleDelete = async  ()=>{
   const res = await fetch("https://emommerce-project2-1.onrender.com/user/deleteUserAccount",{
    method:"DELETE",
    credentials:"include"
   })
   const response = await res.json()
...
const submit = async  (e)=>{
  ...
  const response = await fetch(("https://emommerce-project2-1.onrender.com/user/getuserdetail"),{
    method:"POST",
    headers:{
